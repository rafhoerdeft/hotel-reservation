...
<head>
	...
	<meta property="og:image" content="<?= base_url('assets/img/logo/404.png') ?>" />
	<link rel="icon" type="image/png" href="<?= base_url('assets/img/logo/404.png') ?>">
...
<body>
	...
	<svg class="yetiSVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 470">
	...
	<svg class="lightSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 470">
	...
	<div class="content">
		...
		<p>Mohon maaf, link halaman yang Anda cari tidak dapat ditemukan.</p>
		<div>
			<style>
				.btn-back {
					background: #67b1e0;
	...
	<script>
		...
		chatterTL
			.to(['#mouthBG', '#mouthPath', '#mouthOutline'], .1, {
